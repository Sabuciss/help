    ...
    @if (Auth::user()->isAdmin())
        <form method="POST" action="{{ route('tickets.update', $ticket) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="first_name" name="first_name" value="{{ old('first_name', $ticket->first_name) }}" disabled>
                @error('first_name')
            ...
            <div class="form-group">
                ...
                <input type="text" id="last_name" name="last_name" value="{{ old('last_name', $ticket->last_name) }}" disabled>
                @error('last_name')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="class_department" name="class_department" value="{{ old('class_department', $ticket->class_department) }}" disabled>
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="{{ old('title', $ticket->title) }}" disabled>
                @error('title')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" disabled>{{ old('description', $ticket->description) }}</textarea>
                @error('description')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="file-upload-box" style="opacity: 0.5; cursor: not-allowed;">
                    <p>Failu pievienošana nav atļauta</p>
                </div>
                <input type="file" id="attachments" name="attachments[]" multiple style="display: none;" accept="image/*,.pdf,.doc,.docx" disabled>
